...
function autocomplete(inp, arr) {
    /*Recibe dos argumentos, el input donde aparece y los datos que emplea para proponer
    el autorrelleno:*/
    var currentFocus;
    /*espera a que el input reciba una entrada de texto para iniciar la funcion:*/
    inp.addEventListener("input", function(e) {
        var a, b, i, val = this.value;
        /*cierra el resto de autorrellenos*/
        closeAllLists();
        if (!val) { return false;}
        currentFocus = -1;
